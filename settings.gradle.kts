...
include(":kotlin-debugger-project:kotlin-debugger-bistoury:kotlin-debugger-bistoury-proxy")
include(":kotlin-debugger-project:kotlin-debugger-bistoury:kotlin-debugger-bistoury-remoting")
include(":kotlin-debugger-project:kotlin-debugger-bistoury:kotlin-debugger-bistoury-serverside-common")

include(":kotlin-debugger-project:kotlin-debugger-arthas:kotlin-debugger-arthas-client")
include(":kotlin-debugger-project:kotlin-debugger-arthas:kotlin-debugger-arthas-common")
include(":kotlin-debugger-project:kotlin-debugger-arthas:kotlin-debugger-arthas-cli")