...
public interface Factory {
     ...
     */
    Object newInstance(com.wanna.framework.cglib.proxy.Callback callback);
     ...
     * @return new instance of the same type
     */
    Object newInstance(com.wanna.framework.cglib.proxy.Callback[] callbacks);
     ...
     * @return new instance of the same type
     */
    Object newInstance(Class[] types, Object[] args, com.wanna.framework.cglib.proxy.Callback[] callbacks);
     ...
     */
    com.wanna.framework.cglib.proxy.Callback getCallback(int index);
     ...
     */
    void setCallback(int index, com.wanna.framework.cglib.proxy.Callback callback);
     ...
     * @param callbacks the new callbacks(s) to use
     */
    void setCallbacks(com.wanna.framework.cglib.proxy.Callback[] callbacks);
