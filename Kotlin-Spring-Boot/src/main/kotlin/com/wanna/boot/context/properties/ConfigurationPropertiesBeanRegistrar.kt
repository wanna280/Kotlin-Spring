...
import com.wanna.boot.context.properties.ConfigurationPropertiesBean.BindMethod.Companion
...
open class ConfigurationPropertiesBeanRegistrar(private val registry: BeanDefinitionRegistry) {
     ...
     */
    open fun register(type: Class<*>, attributes: AnnotationAttributes?) {
     ...
     */
    private fun getName(type: Class<*>, attributes: AnnotationAttributes?): String {
