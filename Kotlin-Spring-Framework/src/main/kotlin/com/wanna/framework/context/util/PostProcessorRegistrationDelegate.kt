...
class PostProcessorRegistrationDelegate {
    ...
    companion object {
        ...
        fun registerBeanPostProcessors(
            ...
            val beanPostProcessors = beanFactory.getBeansForType(BeanPostProcessor::class.java)
            // 注册BeanPostProcessor
            beanPostProcessors.forEach { beanName, processor ->
                applicationContext.addBeanPostProcessor(processor)
            }
        }
    }
}